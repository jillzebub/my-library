-- A library of my books with accurate published year/author name/page numbers
-- Create a procedure to assign books as out on loan by specific ficitonal members
-- Aggregate functions show the members with the oldest and newest memberships, to target promotions.
